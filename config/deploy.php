...
return [
    ...
    */
    ...
    'options' => [
        ...
        'repository' => 'https://github.com/ljonny18/jw-website-laravel.git',
    ],
    ...
    */
    ...
    'hosts' => [
        'https://jon-williams.dev/' => [
            'deploy_path' => '/home/jonwrdhy/public_html/repositories/jw-website-laravel',
            // 'user' => 'root',
            'user' => 'jonwrdhy',
